...
export function AppNavigation({navigation}){
	...
	const onMouseMove = (e) => {
		...
		//   ? null
		//   : e.clientX - ((e.target.previousSibling.getElementsByClassName('title')[0].getBoundingClientRect().left +
		// (e.target.previousSibling.getElementsByClassName('title')[0].getBoundingClientRect().width)))
		...
		// console.log('onMouseMove', (_range - (e.currentTarget.getBoundingClientRect().left)), e.clientX, (_range -
		// (e.currentTarget.getBoundingClientRect().left)) - e.clientX) console.log('onMouseMove', e.clientX,
		// targetTitle.getBoundingClientRect().left,
		// e.target.previousSibling.getElementsByClassName('title')[0].getBoundingClientRect().left)
		// console.log('onMouseMove', e.clientX, e.clientY) console.log('onMouseMove', e.clientX -
		// target.getBoundingClientRect().left) console.log('bgRef.current',
		// getComputedStyle(bgRef.current).backgroundColor) console.log('onMouseMove',
		// hexToRgb(variables[`brand_${slug}`])); console.log('onMouseMove', e.target); console.log('onMouseMove',
		// getRGBdiff(currentColor, prevSiblingColor));
	}
			...
			<motion.div
				...
				<div className='intro-action p-top-28 md-p-top-30'>
					<Link
							target={'_self'}
							href={
								!userId ? 'https://auth.pirveli.com/realms/xracoon-demo/protocol/openid-connect/registrations?client_id=demo-client&response_type=code&scope=email&redirect_uri=https://pirveli.com/main/page' : process.env.PROFILE_LINK
							}>
						<Button
					...
					<div className='playBtn'>
						<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<g clipPath="url(#clip0_3249_11327)">
								<path d="M45 42V58L58 50L45 42Z" stroke="white" strokeWidth="2" strokeLinecap="round"
